...
<div class= " container-fluid justify-content-center align-content-center target  .mx-auto mt-3"  style="border-radius: 20pt;min-width:250pt; width:40%; background-color:rgb(255, 101, 45); color:black; padding: 20pt;">
        ...
        <div class="container">
           ...
           <p style="color:brown">Invalid Details</p>
           <a href="http://localhost:8082/Inbox/empform" style="color:azure">Click To Login</a>
       </div>
       </div>
