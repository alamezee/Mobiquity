        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="container">
                            ...
                            <div>
                                    <ul class="nav flex-column" style="color: beige;">
                                      ...
                                      <li class="nav-item">
                                        <a class="nav-link text-white Unread active" style="font-size:15pt;" ><b>Unread</b></a>
                                      </li>
                                      <li class="nav-item">
                                        <a class="nav-link text-white Archive" style="font-size:15pt; " >Archive</a>
                                      </li>
                                    </ul>
                  ...
                  <div class="col-sm-10 sc" style="background-color:rgb(204, 204, 204); border:2%; min-height:100pt;">
                    <h2 style="margin-left:15px;margin-top:10px">Unread</h2>
                    <div class="container row">
                      ...
                      <c:if test="${ msg.read==false && msg.delete==false}">
                        <tr >
                            ...
                            <td id = "hi" class="view-message  dont-show bold"><div class="table-row"  data-toggle="modal" data-target="#myModal"><b>${msg.sender}</b></div></div></td>
                            <td class="view-message "><b>${msg.subject}</b><td>
                            
                            <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"><div class="table-row"  data-toggle="modal" data-target="#myModal"><b>${msg.content}</b></div></i></td>
